...
4. **@specialists/technical/frontend-dev.md**
...
- **@workflows/development/test-automation.md**
  - E2E test script development
  - User journey automation
  - Continuous testing setup

- **@workflows/operations/monitoring.md#synthetic**
  - Synthetic monitoring setup
  - Automated health checks
  - Performance baseline creation

- **@workflows/development/pdf-generation.md**
...
**Specialists**: @specialists/technical/backend-dev.md
...
## Memory Integration
- **Automation Scripts**: @memory/knowledge/automation-library.md
- **Test Scenarios**: @memory/context/test-scenarios.md
- **Performance Baselines**: @memory/knowledge/performance-metrics.md
